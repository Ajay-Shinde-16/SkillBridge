          ...
          <div className="collapse navbar-collapse" id="navMenu">
            ...
            <ul className="navbar-nav align-items-center gap-2">
              {!user ? (
                <>
                  <li className="nav-item">
                    <Link to="/login" className="btn btn-sm fw-semibold px-3 rounded-pill d-flex align-items-center gap-1"
                      style={{background:'transparent',color:'#fff',border:'1.5px solid #fff',fontSize:'0.82rem'}}>
                      <i className="bi bi-person"></i>Login
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/register" className="btn btn-sm fw-semibold px-3 rounded-pill d-flex align-items-center gap-1"
