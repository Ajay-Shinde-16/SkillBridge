          ...
          <div className="card shadow border-0 rounded-4">
            <div className="card-body p-5">
              <div className="text-center mb-4">
                <img src="/logo.svg" alt="SkillBridge" width="52" height="52" style={{borderRadius:14}} onError={e=>e.target.style.display='none'}/>
                <h3 className="fw-bold mt-2 mb-1">Create Account</h3>
                <p className="text-muted small">Join SkillBridge today — 100% free</p>
              </div>
