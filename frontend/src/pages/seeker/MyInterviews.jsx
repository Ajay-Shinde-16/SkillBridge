...
const modeInfo = {
  VIDEO:     { icon:'bi-camera-video-fill', label:'Video Call',  color:'#15487F' },
    ...
    <div className="container py-4">
      ...
      <div className="row g-3 mb-4">
        {[
          ...
          {label:'Passed',    value:interviews.filter(i=>i.result==='PASS').length, color:'#15487F', bg:'#DBEAFE'},
      ...
      <div className="d-flex flex-wrap gap-2 mb-4">
        {['ALL','SCHEDULED','COMPLETED','CANCELLED'].map(s=>(
          <button key={s} className="btn btn-sm rounded-pill fw-semibold"
            style={{background:filter===s?'#15487F':'#EEF3F8',color:filter===s?'#fff':'#15487F',border:'none'}}
            onClick={()=>setFilter(s)}>
                  ...
                  <div className="card-body p-4">
                    ...
                    <div className="d-flex flex-column gap-2 mb-3" style={{fontSize:'0.85rem'}}>
                      <div className="d-flex align-items-center gap-2">
                        <i className="bi bi-calendar flex-shrink-0" style={{color:'#15487F',width:18}}></i>
                      ...
                      {iv.meetingLink && (
                        <div className="d-flex align-items-center gap-2">
                          <i className="bi bi-link-45deg flex-shrink-0" style={{color:'#15487F',width:18}}></i>
                          <a href={iv.meetingLink} target="_blank" rel="noreferrer"
                            className="text-truncate" style={{color:'#15487F',fontSize:'0.8rem'}}>
                            {iv.meetingLink}
                          </a>
                        </div>
                      )}
                    ...
                    {iv.meetingLink && iv.status==='SCHEDULED' && (
                      <a href={iv.meetingLink} target="_blank" rel="noreferrer"
                        ...
                        style={{background:'#15487F',fontSize:'0.85rem'}}>
