      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          ...
          <div className="d-flex gap-0 mb-4" style={{ borderBottom:'2px solid #e2e8f0' }}>
            {[
              ...
              <button key={tab.key}
                ...
                style={{
                  borderBottom: activeTab===tab.key ? '2px solid #123160' : '2px solid transparent',
                  color: activeTab===tab.key ? '#123160' : '#6c757d',
          ...
          {activeTab === 'profile' && (
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-body p-4">
                <h6 className="fw-bold mb-3 d-flex align-items-center gap-2" style={{ color:'#123160' }}>
                ...
                <button className="btn text-white fw-bold mt-4 px-5 rounded-pill" style={{ background:'#123160' }} onClick={handleSave} disabled={saving}>
          ...
          {activeTab === 'password' && (
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-body p-4">
                <h6 className="fw-bold mb-1 d-flex align-items-center gap-2" style={{ color:'#123160' }}>
                ...
                <form onSubmit={handleChangePassword}>
                  ...
                  <button type="submit" className="btn text-white fw-bold mt-4 px-5 rounded-pill"
                    style={{ background:'#123160' }} disabled={pwdLoading}>
                ...
                <div className="mt-4 p-3 rounded-3" style={{ background:'#EEF3F8' }}>
                  <div className="small fw-semibold mb-2" style={{ color:'#123160' }}>
                ...
                <div className="mt-4 p-3 rounded-3 d-flex align-items-center justify-content-between flex-wrap gap-2"
                  ...
                  <div>
                    <div className="fw-semibold small">
                      <i className="bi bi-shield-lock-fill me-1" style={{color:'#123160'}}></i>
            ...
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-body p-4">
                <h6 className="fw-bold mb-3 d-flex align-items-center gap-2" style={{ color:'#123160' }}>
                  ...
                  <span className="badge ms-1" style={{ background:'#EEF3F8', color:'#123160', fontSize:'0.7rem' }}>PDF Only</span>
                </h6>
                      ...
                      <div key={r.id} className="rounded-3 p-3 mb-2 d-flex align-items-center gap-3 flex-wrap"
                        ...
                        <div className="d-flex gap-2 flex-wrap">
                          <a href={`${import.meta.env.VITE_API_URL || ''}/api/files/resumes/${r.id}/view`}
                            ...
                            className="btn btn-sm fw-semibold rounded-pill" style={{ background:'#123160', color:'#fff', fontSize:'0.75rem' }}>
                            <i className="bi bi-eye me-1"></i>View
                          </a>
                          {!r.isPrimary && (
                            <button className="btn btn-sm fw-semibold rounded-pill" onClick={() => handleSetPrimary(r.id)}
                              style={{ background:'#EEF3F8', color:'#123160', border:'1px solid #123160', fontSize:'0.75rem' }}>
                ...
                <div className="rounded-3 p-4 text-center"
                  ...
                  onDragOver={e=>{e.preventDefault();e.currentTarget.style.borderColor='#123160'}}
                  ...
                  {uploading ? (
                    <><div className="spinner-border mb-2" style={{ color:'#123160' }}></div><div style={{ color:'#123160' }}>Uploading...</div></>
                  ) : (
                    <>
                      <i className="bi bi-cloud-upload fs-1 mb-2 d-block" style={{ color:'#123160' }}></i>
                      ...
                      <div className="mt-2 d-flex gap-2 justify-content-center">
                        <span className="badge rounded-pill" style={{ background:'#EEF3F8', color:'#123160', fontSize:'0.72rem' }}>PDF only</span>
                        <span className="badge rounded-pill" style={{ background:'#EEF3F8', color:'#123160', fontSize:'0.72rem' }}>Max 5MB</span>
                        <span className="badge rounded-pill" style={{ background:'#EEF3F8', color:'#123160', fontSize:'0.72rem' }}>Up to 5 resumes</span>
                      </div>
                    </>
                  )}
                </div>
              ...
              {suggestedSkills.length > 0 && (
                <div className="mt-3 p-3 rounded-3" style={{ background:'#EEF3F8', border:'1px solid #123160' }}>
                  <div className="fw-semibold mb-2" style={{ color:'#123160', fontSize:'0.85rem' }}>
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {suggestedSkills.map((skill, i) => (
                      <span key={i} className="d-inline-flex align-items-center gap-1 rounded-pill px-2 py-1"
                        style={{ background:'#fff', border:'1px solid #123160', fontSize:'0.78rem' }}>
                        {skill}
            ...
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-body p-4">
                ...
                <div className="input-group" style={{ maxWidth:380 }}>
                  ...
                  <button className="btn text-white fw-semibold rounded-end-3" style={{ background:'#123160' }} onClick={addSkill}>
